...
def render():
    st.header("🔧 Pit Stops Analysis")

    st.info(
        "Pit stop data exists only from 2011 onward. "
        "Earlier seasons have no pit stop records."
    )
    ...
    st.bar_chart(summary.set_index("Driver")["Avg_Pit_Time_sec"])
